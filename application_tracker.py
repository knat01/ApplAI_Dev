...
def show_tracker():
    ...
    with st.expander("Add New Application"):
        ...
        status = st.selectbox("Status", ["Applied", "Interview Scheduled", "Offer Received", "Rejected"])
    ...
    for app in applications:
        ...
        with st.expander(f"{app_data['company']} - {app_data['position']}"):
            ...
            # Update status
            new_status = st.selectbox("Update Status", ["Applied", "Interview Scheduled", "Offer Received", "Rejected"], key=app.id)
